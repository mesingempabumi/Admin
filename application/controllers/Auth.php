...
class auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        //     'smtp_user' => 'hapiidpratama78@gmail.com',
        //     'smtp_pass' => 'FridayKiller6year',
        //     'smtp_port' => 587,
        //     'mailtype'  => 'html',
        //     'charset'   => 'utf-8',
        //     'newline'   => "\r\n"
        ...
        $this->email->from('hapiidpratama78@gmail.com', 'M. Hafiid');
        ...
        if ($user) {
            ...
            if ($user_token) {
                if (time() - $user_token['date_created'] < (60 * 60 * 24)) {
                    ...
                    $this->session->set_flashdata('message', '<div class="alert alert-success", role="alert">' . $email . ' has been acctivated! Please login.</div>');
                    redirect('auth');
                } else {
    ...
    public function logout()
    {
        ...
        $this->session->set_flashdata('message1', '<div class="alert alert-success", role="alert">You have been logged out!
        </div>');
        redirect('auth');
    }
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-success", role="alert">Please check your email to reset your password!
                </div>');
            } else {
